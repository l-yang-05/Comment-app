...
const LikeButton = () => {
	...
	return (
		<span style={styleThumbs} onClick={() => handleLikes()}> {counter}
			<svg 
			x="0px" 
			y="0px"
			viewBox="0 0 155.123 155.123" 
			styles="enable-background:new 0 0 155.123 155.123;" 
			width="40px"
			height="40px">
			<g>
			<g>
			<path styles="fill:#010002;" d="M150.669,84.068c7.858-7.823,5.43-23.647-8.181-23.647l-35.813,0.024
