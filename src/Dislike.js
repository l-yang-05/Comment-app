...
const DislikeButton = () => {
	...
	return (
		<span onClick={() => handleDislikes()}> {counter}
		<svg
		x="0px" 
		y="0px"
		viewBox="0 0 155.129 155.129" 
		styles="enable-background:new 0 0 155.129 155.129;"
		height="40px"
		width="40px">
		<g>
		<g>
		<path styles="fill:#010002;" d="M4.454,71.061c-7.858,7.829-5.43,23.653,8.181,23.653l35.813-0.024
